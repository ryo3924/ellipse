...
def main():
    img = cv2.imread('C:\\Users\\81804\\Pictures\\realsense\\Color.png', cv2.IMREAD_COLOR)

    #\img = cv2.imread('C:/Users/81804/Pictures/hamgurg.bmp',cv2.IMREAD_COLOR)

    cv2.imshow('testshow.o',img)
    ...
    cv2.imshow('testshow.bw',binimg)
    #cv2.imwrite('C:/Users/81804/Pictures/hamgurg.bmp',binimg)
    
    # 結果画像の黒の部分を灰色にする。
    bimg = binimg // 4 + 255 * 3 //4
    resimg = cv2.merge((bimg,bimg,bimg)) 

    cv2.imshow('testshow.g',resimg)
    """
    # 輪郭取得
